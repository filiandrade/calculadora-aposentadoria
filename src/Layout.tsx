        ...
        <div className="mx-auto max-w-4xl flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Link to="/" className="flex items-center gap-3 select-none" style={{textDecoration: 'none'}}>
              <img src="/logo-simbolo-sigma.png" alt="Logo Minhas Calculadoras" className="w-12 h-12 rounded-2xl shadow-lg border border-neutral-200 bg-white/40" style={{boxShadow: '0 4px 16px 0 #0002'}} />
