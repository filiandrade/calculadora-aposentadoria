        ...
        <div className="mx-auto max-w-4xl flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Link to="/" className="flex items-center gap-3 select-none" style={{textDecoration: 'none'}}>
              <span className="rounded-full bg-black text-white px-4 py-2 text-2xl font-bold tracking-tight shadow-lg border border-neutral-200" style={{letterSpacing: '-0.04em', boxShadow: '0 2px 12px 0 #0001'}}>Σ</span>
